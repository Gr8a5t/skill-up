<footer class="footer">
    ...
    <div class="section footer-top bg-dark has-bg-image" style="background-image: url('{{ asset('fitlife-assets/images/footer-bg.png') }}')">
        <div class="container">
          ...
          <p class="footer-brand-text">
            SkillUp curates free skill-building resources, curated roadmaps, and small accountability nudges for every young learner.
                ...
                <div class="wrapper">
                    ...
                    <img src="{{ asset('fitlife-assets/images/footer-clock.png') }}" width="34" height="34" loading="lazy"
                        alt="Clock">
            ...
            <address class="address footer-link">
              Chicago, IL · Remote-first team
                ...
                <li class="footer-list-item">
                    ...
                    <div>
                        <a href="tel:18001213637" class="footer-link">1800-SKILL-UP</a>

                        <a href="tel:+13125551234" class="footer-link">+1 312 555-1234</a>
                    </div>
                </li>
                ...
                <li class="footer-list-item">
                    ...
                    <div>
                        <a href="mailto:hello@skillup.com" class="footer-link">hello@skillup.com</a>

                        <a href="mailto:team@skillup.com" class="footer-link">team@skillup.com</a>
                    </div>
                </li>
