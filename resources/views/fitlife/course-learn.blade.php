        ...
        <div class="learn-main-col">
            ...
            <header class="course-header">
                ...
                <div class="action-row">
                    <button class="icon-btn" id="open-workspace-btn" title="Open Code Workspace" onclick="window.openSkillUpWorkspace()"><ion-icon name="code-slash-outline"></ion-icon></button>
